...
function installFollowupLayout(){
  if(!document.getElementById('tm-followup-wide-style')){
    ...
    st.textContent=[
      ...
      '#page-followup .tm-fu-head-sort{margin-left:5px;padding:0;width:18px;height:18px;border:0;background:transparent;color:#4b5e78;font-size:12px;font-weight:800;line-height:18px;cursor:pointer;vertical-align:middle;border-radius:4px}',
