...
function comLeads(rows,fn){
  var wprev=window.leads, lprev;
...
function boot(){
  ...
  window.renderDashboard=function(){
    ...
    return comLeads(filtrar(base,'dash-periodo'),rd);
  };
  window.renderKanban=function(){
    var base=Array.isArray(window.leads)?window.leads:[];
    return comLeads(filtrar(base,'kanban-periodo'),rk);
  };
